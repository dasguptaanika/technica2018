...
#Nursery Rhyme
      ...
      print("Enter a nursery rhyme! No punctuation! Hit enter to continue.")
      if(choice2 == 0):
          rhyme = "***Twinkle Twinkle Little Star***: "
          corrAnswer = ("twinkle twinkle little star how I wonder what you are up above the world so high like a diamond in the sky twinkle twinkle little star how I wonder what you are")
      elif(choice2 == 1):
          rhyme = "Baa Baa Black Sheep! "
          corrAnswer = ("baa baa black sheep have you any wool yes sir yes sir three bags full one for the master one for the dame one for the little boy who lives down the lane")
      elif(choice2 == 2):
          rhyme = "The Itsy Bitsy Spider! "
          corrAnswer = ("the itsy bitsy spider climbed up the waterspout down came the rain and washed the spider out out came the sun and dried up all the rain and the itsy bitsy spider climbed up the spout again")
      else:
          rhyme = "Roses are red: "
          corrAnswer = ("roses are red violets are blue sugar is sweet and so are you")
